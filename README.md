...
- Tap a scan to preview pages in-app — sharing or deleting are the only
  actions today
- Custom filenames when sharing (everything goes out as `doc.pdf` /
  `page-N.jpg`)
- Rename, star, search, or "delete all"
- Settings screen
